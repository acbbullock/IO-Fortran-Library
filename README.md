...
The complete API documentation was generated by [FORD](https://github.com/Fortran-FOSS-Programmers/ford) and can be previewed at [API-doc](https://htmlpreview.github.io/?/doc/index.html). To view the documentation locally, clone this repository and view `/doc/index.html` in your browser.
