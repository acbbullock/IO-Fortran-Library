...
* [`interface str`](https://github.com/acbbullock/IO-Fortran-Library#pure-function-str): A function for representing a number as a string.
* [`interface echo`](https://github.com/acbbullock/IO-Fortran-Library#impure-subroutine-echo): A subroutine for recording a string to an external file.
* [`interface to_file`](https://github.com/acbbullock/IO-Fortran-Library#impure-subroutine-to_file): A subroutine for recording an array to an external file.
* [`interface from_file`](https://github.com/acbbullock/IO-Fortran-Library#impure-subroutine-from_file): A subroutine for reading an external file into an array.
* [`interface aprint`](https://github.com/acbbullock/IO-Fortran-Library#impure-subroutine-aprint): A subroutine for printing array sections to stdout.
* [`type String`](https://github.com/acbbullock/IO-Fortran-Library#type-string): A wrapper type for an allocatable string.
* [`parameter nl`](https://github.com/acbbullock/IO-Fortran-Library#parameter-nl): The new line character constant.

For a complete API documentation, see [API-doc](https://htmlpreview.github.io/?https://github.com/acbbullock/IO-Fortran-Library/blob/dev2/doc/index.html), which was generated by [FORD](https://github.com/Fortran-FOSS-Programmers/ford). The remainder of this document provides a quick reference on how to use the public interfaces listed above.
