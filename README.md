...
For a complete API documentation, see [API-doc](https://htmlpreview.github.io/?https://github.com/acbbullock/IO-Fortran-Library/tree/dev2/doc/index.html), which was generated by [FORD](https://github.com/Fortran-FOSS-Programmers/ford). The remainder of this document provides a quick reference on how to use the public interfaces listed above.
