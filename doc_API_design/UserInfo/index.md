...
ordered_subpage: text-fmts.md
ordered_subpage: locale-fmts.md
ordered_subpage: file-ext.md
ordered_subpage: error-codes.md
ordered_subpage: compilers.md
ordered_subpage: characters.md
ordered_subpage: thread-safety.md
---

The following subsections detail important information for users:

* [Numeric text formats](text-fmts.html)
