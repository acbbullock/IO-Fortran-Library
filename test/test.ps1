...
fpm test --compiler ifx --flag "/stand:f18 /warn:all /check:all /error-limit:1 /Od /Z7 /traceback /assume:byterecl"
fpm test --compiler ifx --flag "/stand:f18 /O3"

fpm test --compiler ifort --flag "/stand:f18 /warn:all /check:all /error-limit:1 /Od /Z7 /traceback /assume:byterecl"
